...
ColorRampLayerRenderCtrlBase::ColorRampLayerRenderCtrlBase( wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size, long style, const wxString& name ) : wxPanel( parent, id, pos, size, style, name )
{
	...
	gbSizer1->Add( m_staticText8, wxGBPosition( 3, 0 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_txtPivot = new wxTextCtrl( this, wxID_ANY, wxEmptyString, wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _txtPivot, wxGBPosition( 3, 1 ), wxGBSpan( 1, 7 ), wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );

	m_staticText9 = new wxStaticText( this, wxID_ANY, wxT("LT Pivot"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText9->Wrap( -1 );
	gbSizer1->Add( m_staticText9, wxGBPosition( 4, 0 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkLtPivotR = new wxCheckBox( this, wxID_ANY, wxT("R"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkLtPivotR, wxGBPosition( 4, 1 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkLtPivotG = new wxCheckBox( this, wxID_ANY, wxT("G"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkLtPivotG, wxGBPosition( 4, 2 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkLtPivotB = new wxCheckBox( this, wxID_ANY, wxT("B"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkLtPivotB, wxGBPosition( 4, 3 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	m_staticText91 = new wxStaticText( this, wxID_ANY, wxT("GT Pivot"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText91->Wrap( -1 );
	gbSizer1->Add( m_staticText91, wxGBPosition( 4, 4 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkGtPivotR = new wxCheckBox( this, wxID_ANY, wxT("R"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkGtPivotR, wxGBPosition( 4, 5 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkGtPivotG = new wxCheckBox( this, wxID_ANY, wxT("G"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkGtPivotG, wxGBPosition( 4, 6 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_chkGtPivotB = new wxCheckBox( this, wxID_ANY, wxT("B"), wxDefaultPosition, wxDefaultSize, 0 );
	gbSizer1->Add( _chkGtPivotB, wxGBPosition( 4, 7 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	m_staticText51 = new wxStaticText( this, wxID_ANY, wxT("Opacity"), wxDefaultPosition, wxDefaultSize, 0 );
	m_staticText51->Wrap( -1 );
	gbSizer1->Add( m_staticText51, wxGBPosition( 5, 0 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_lblOpacityValue = new wxStaticText( this, wxID_ANY, wxT("255"), wxDefaultPosition, wxDefaultSize, 0 );
	_lblOpacityValue->Wrap( -1 );
	gbSizer1->Add( _lblOpacityValue, wxGBPosition( 5, 1 ), wxGBSpan( 1, 1 ), wxALL|wxALIGN_CENTER_VERTICAL, 5 );

	_sldOpacity = new wxSlider( this, wxID_ANY, 255, 0, 255, wxDefaultPosition, wxDefaultSize, wxSL_HORIZONTAL );
	gbSizer1->Add( _sldOpacity, wxGBPosition( 5, 2 ), wxGBSpan( 1, 6 ), wxALL|wxEXPAND|wxALIGN_CENTER_VERTICAL, 5 );
